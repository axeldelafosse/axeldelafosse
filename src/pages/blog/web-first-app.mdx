...
<blockquote className="twitter-tweet" data-theme="light">
  <p lang="en" dir="ltr">
    Hot take: we will see a lot of mobile app development amount to
    &quot;Cordova-style React Native&quot; <br />
    <br />
    i.e.: apps will consist of HTML+CSS+JS (in stale-while-revalidate mode,
    aggressively trying to self-hot-upgrade upon boot).
    <br />
    <br />
    RN will act as the cross-platform FFI to missing web APIs
  </p>
  &mdash; Guillermo Rauch (@rauchg) <a href="https://twitter.com/rauchg/status/1223446855482167302?ref_src=twsrc%5Etfw">
    February 1, 2020
  </a>
</blockquote>
